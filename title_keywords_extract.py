"""
file_name:title_keywords_extract.py

说明：title_keywords_extract.py是提取数据库joke库cnki_qikan表里的
里面的title keywords信息，存在csv文件里
...
def main():
    ...
    for i in result:
        ...
        for keyword in keywords:
            dict1 = {}
            dict1['title'] = i[2]
            dict1['keywords'] = keyword
            list1.append(dict1)
    print(list1)
    with open(output_route + "title_keywords.csv", 'a', newline='', encoding='utf-8') as f:
